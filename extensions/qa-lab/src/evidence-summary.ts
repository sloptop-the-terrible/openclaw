...
const qaEvidenceResolvedChannelSchema = z.strictObject({
  id: nonEmptyStringSchema,
  live: z.boolean(),
...
const qaEvidenceChannelSchema = z.union([
  qaEvidenceResolvedChannelSchema,
  z.strictObject({
    id: nonEmptyStringSchema,
...
type QaResolvedEvidenceChannel = z.infer<typeof qaEvidenceResolvedChannelSchema>;
export type QaEvidenceChannelInput =
  | Omit<QaResolvedEvidenceChannel, "live">
  | Exclude<QaEvidenceChannel, QaResolvedEvidenceChannel>;
