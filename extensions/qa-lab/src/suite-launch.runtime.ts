...
function buildQaEvidenceChannelInput(params: {
  ...
  if (params.channelDriver) {
    return {
      ...
      requestedDriver:
        params.requestedDriver === params.channelDriver ? undefined : params.requestedDriver,
    };
  }
      ...
      for (const partition of flowPartitions) {
        ...
        const task: QaUnifiedPartitionTask = {
          ...
          exclusiveKey: channelDriverFlowRequiresExclusiveWorkers
            ...
            : undefined,
          requestedDriver:
            params.runParams?.channelDriver ?? channelGroup.channelDriverSelection?.channelDriver,
      ...
      evidenceSummaries: [
        buildQaSuiteEvidenceSummary({
          ...
          channel: buildQaEvidenceChannelInput({
            channelId: task.channelId,
            channelDriver: task.channelDriver,
            requestedDriver: task.requestedDriver,
          }),
          env: process.env,
          generatedAt: new Date().toISOString(),
          primaryModel,
